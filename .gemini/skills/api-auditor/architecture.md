...
- **SEMPRE** use `z.nativeEnum(Weekday)` importado de `../generated/prisma/enums.js` para tipar campos de dia da semana nos schemas Zod. **NUNCA** use `z.string()` ou `z.enum()` manual para representar Weekday, garantindo sincronia com o banco de dados.
