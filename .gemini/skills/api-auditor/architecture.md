...
- **SEMPRE** use `z.enum(WeekDay)` importado de `../generated/prisma/enums.js` para tipar campos de dia da semana nos schemas Zod. **NUNCA** use `z.string()` para representar WeekDay.
